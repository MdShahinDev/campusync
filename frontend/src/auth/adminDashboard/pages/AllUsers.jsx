...
const users = [
  ...
  { id: 2, name: "Jane Smith", email: "jane@university.edu", role: "Moderator", department: "Engineering", status: "Active" },
  ...
  { id: 6, name: "Emily Davis", email: "emily@university.edu", role: "Moderator", department: "Computer Science", status: "Active" },
];
