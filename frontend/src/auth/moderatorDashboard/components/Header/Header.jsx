              ...
              {dropdownOpen && (
                ...
                >
                  <div className="px-3 py-2.5 border-b border-border-color">
                    <p className="text-xs font-semibold text-text-primary">{user?.name || "Moderator"}</p>
                    <p className="text-[10px] text-text-muted mt-0.5 truncate">{user?.email || "moderator@campusync.com"}</p>
                  </div>
                  <div className="py-1">
                    <DropdownItem icon={<LayoutDashboard size={14} />} label="Dashboard" to="/moderator/dashboard" onClick={() => setDropdownOpen(false)} />
                    <DropdownItem icon={<User size={14} />} label="Profile" to="/moderator/profile" onClick={() => setDropdownOpen(false)} />
                    <DropdownItem icon={<Settings size={14} />} label="Settings" to="/moderator/settings" onClick={() => setDropdownOpen(false)} />
                  </div>
