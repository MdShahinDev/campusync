...
export default function Dashboard() {
  ...
  const [stats, setStats] = useState({
    totalStudents: 0, pendingUsers: 0, totalResources: 0, totalComponents: 0, recentActivities: [],
  });
  ...
  const statCards = [
    { label: "Total Students", value: stats.totalStudents, icon: Users, accent: "bg-blue-500" },
    { label: "Pending Users", value: stats.pendingUsers, icon: Clock, accent: "bg-amber-500" },
    { label: "Total Resources", value: stats.totalResources, icon: BookOpen, accent: "bg-violet-500" },
  ...
  return (
    <div className="space-y-6 max-w-[1400px]">
      ...
      <motion.div initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }}
        transition={{ delay: 0.25 }} className="dash-section">
