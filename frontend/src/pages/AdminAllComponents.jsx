...
export default function AdminAllComponents() {
            ...
            >
              ...
              <div className="p-4">
                ...
                <div className="pt-3 border-t border-border-color flex gap-2">
                  <Link
                    to={`/components/${comp._id}`}
                    className="flex-1 flex items-center justify-center gap-2 px-4 py-2.5 rounded-xl bg-gradient-to-r from-[#FF8A00] via-[#FF7B00] to-[#FF6B00] text-white text-sm font-bold shadow-lg shadow-orange-500/20 hover:shadow-orange-500/40 hover:-translate-y-0.5 active:translate-y-0 transition-all duration-200"
                  >
                    <Package size={14} />
                    View
                  </Link>
                  <button
                    ...
                    className="px-3 py-2.5 rounded-xl bg-red-500/10 text-red-500 hover:bg-red-500/20 transition-colors"
